...
import { LogIn, Mail, Lock, EyeOff, Eye, Trees, Loader2 } from 'lucide-react'
        ...
        >
            ...
            <div className="bg-white/90 backdrop-blur-xl rounded-3xl sm:rounded-[1.5rem] shadow-[0_8px_32px_rgba(0,0,0,0.1)] w-full max-w-[360px] p-5 sm:p-6 md:p-8 relative z-10 border border-white/50">
                ...
                <form className="space-y-3" onSubmit={handleLogin}>
                    ...
                    <div className="flex justify-end pt-1 mb-5">
                ...
                <div className="relative my-6">
                    ...
                    <div className="relative flex justify-center text-xs">
                        <span className="bg-white px-4 text-slate-400 rounded-full">Or sign in with</span>
                    </div>
                </div>
                ...
                <div className="mt-6 text-center">
                    <p className="text-slate-600 text-sm">
                        Don't have an account? <Link to="/signup" className="text-slate-900 font-bold hover:underline">Sign up</Link>
                    </p>
                </div>
            </div>
